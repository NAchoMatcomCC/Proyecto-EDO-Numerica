...
Para la realización de este trabajo se emplearon scripts y programas (escritos fundamentalmente en Python) que pueden encontrarse en el \href{https://github.com/NAchoMatcomCC/Proyecto-EDO-Numerica.git}{Repositorio en GitHub}. Adicionalmente se desarrolló un bot de Telegram que facilita la visualización de los resultados para diferentes parámetros, el código del mismo se encuentra en el mismo repositorio.
